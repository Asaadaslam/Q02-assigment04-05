...
const Shawarma = () => {
  return (
    <div className="bg-red-800 min-h-screen flex flex-col items-center justify-center">
      <h1 className="text-8xl font-bold text-black mt-0">Shawarma </h1>

      <div className="imageBurger bg-[url('/shawarma.jfif')] mt-12 p-44 bg-cover bg-center w-64 h-64 rounded-lg shadow-lg mx-auto border-4 border-black"></div>
